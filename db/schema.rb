...
'], :lang => 'plpgsql')
  ...
  create_table "pricing_components_pricing_types", :id => false, :force => true do |t|
  ...
  add_foreign_key "pricing_components_pricing_types", ["pricing_type_id"], "pricing_types", ["id"], :on_delete => :restrict, :name => "pricing_components_pricing_types_pricing_type_id_fkey"
  add_foreign_key "pricing_components_pricing_types", ["pricing_component_id"], "pricing_components", ["id"], :on_delete => :restrict, :name => "pricing_components_pricing_types_pricing_component_id_fkey"
