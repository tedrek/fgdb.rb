...
require 'ostruct'
require 'bluecloth'
require ::Rails.root.to_s + '/lib/fix_stupid_rails.rb'
require ::Rails.root.to_s + '/lib/model_modifications.rb'
require ::Rails.root.to_s + '/lib/ordered_hash.rb'
require ::Rails.root.to_s + '/vendor/prawn-labels/lib/prawn/labels.rb'
require 'csv'
