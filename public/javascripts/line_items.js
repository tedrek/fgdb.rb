...
{
  if(systems_invalid || $('gizmo_type_id').selectedIndex == 0 || ($('covered') != null && $('covered').enabled && $('covered').selectedIndex == 0 && gizmo_context != "sale") || ($('unit_price') != null && $('unit_price').value == '') || ($('gizmo_count') != null && $('gizmo_count').value == '')) {
    return true;
  }
